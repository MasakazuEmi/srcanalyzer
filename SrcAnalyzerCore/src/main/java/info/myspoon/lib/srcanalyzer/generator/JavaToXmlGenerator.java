...
public class JavaToXmlGenerator extends SrcToXmlGenerator {

	public JavaToXmlGenerator(TokenFactory tokenFactory) {
		super(tokenFactory);
	}
	...
	Collection<IAnalyzer> setupAnalyzer() {
		...
		analyzers.add(new KeywordAnalyzer(new TokenAnalyzer(), getToken(Type.java)));

		//TODO java7で追加された0b1(バイナリ表現), "_"による分割表現をサポートしなくてはいけない。
		//数値
